...
See [Pthreads Part 1](https://github.com/bigalex95/modern-cpp-tutorial/blob/master/CProgramming/SystemProgramming.wiki/Pthreads%2C-Part-1:-Introduction) which introduces `pthread_create` and `pthread_join`
